...
func (body *ApiVersionsResponseBody) Encode() []byte {
	// Based on the test output, we need to construct exactly:
	// 00 00: Error code (0 or 35 for unsupported version)
	// 01: Number of API keys (1)
	// 00 12: API key (18 - ApiVersionsKey)
	// 00 00: Min version (0)
	// 00 04: Max version (4)
	// 00: Tag buffer for this API key
