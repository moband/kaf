...
func parseDescribeTopicPartitionsRequest(payload []byte) (*DescribeTopicPartitionsRequest, error) {
	...
	// - 00 02 - topics count
	// - 12 - possibly a type marker or string length indicator for the topic name
	// - Topic name ("unknown-topic-xxx")
	// - 00 00 00 01 ff 00 - trailing data
	...
	// The rest of the payload should contain additional parameters,
	// but for this stage we don't need to parse them
