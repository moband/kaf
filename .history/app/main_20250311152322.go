...
func sendApiVersionsResponse(conn net.Conn, correlationId int32, errorCode uint16) error {
	...
	binary.BigEndian.PutUint16(responseBody[14:16], uint16(MinSupportedVersion)) // Min version (0)
	binary.BigEndian.PutUint16(responseBody[16:18], uint16(MaxSupportedVersion)) // Max version (4)
